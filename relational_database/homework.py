...
def task_10_list_first_10_customers(cur):
    ...
    Results: 10 records
    """
    cur.execute("SELECT customername FROM customers LIMIT 10;")
...
def task_11_list_customers_starting_from_11th(cur):
    ...
    Returns: 11 records
    """
    cur.execute("SELECT customername FROM customers WHERE customerid BETWEEN '11' AND '90';")
...
def task_12_list_suppliers_from_specified_countries(cur):
    ...
    Returns: 8 records
    """
    cur.execute("SELECT suppliername FROM suppliers WHERE country = 'USA' OR country = 'UK' OR country = 'Japan';")
